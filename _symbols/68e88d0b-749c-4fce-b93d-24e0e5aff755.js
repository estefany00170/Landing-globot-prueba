...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(path, "class", "svelte-1ffaqhx");
			attr(svg, "viewBox", "0 0 1440 175");
			attr(svg, "fill", "none");
			attr(svg, "xmlns", "http://www.w3.org/2000/svg");
			attr(svg, "class", "svelte-1ffaqhx");
			...
			attr(img1, "class", "logo svelte-1ffaqhx");
			...
			attr(div0, "class", "section-container svelte-1ffaqhx");
			attr(div1, "class", "text svelte-1ffaqhx");
			attr(section, "class", "svelte-1ffaqhx");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*logo*/ 1 && !src_url_equal(img1.src, img1_src_value = /*logo*/ ctx[0].url)) {
