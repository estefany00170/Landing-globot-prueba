...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			img3 = claim_element(div5_nodes, "IMG", { src: true, alt: true, class: true });
			...
			img4 = claim_element(div6_nodes, "IMG", { src: true, alt: true, class: true });
			...
			img5 = claim_element(div7_nodes, "IMG", { src: true, alt: true, class: true });
			...
			img6 = claim_element(div8_nodes, "IMG", { src: true, alt: true, class: true });
			...
			img7 = claim_element(div9_nodes, "IMG", { src: true, alt: true, class: true });
			...
			img8 = claim_element(button0_nodes, "IMG", { src: true, alt: true });
