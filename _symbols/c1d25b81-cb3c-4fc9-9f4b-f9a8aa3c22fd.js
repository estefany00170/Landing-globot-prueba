...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(img, "class", "background svelte-f0em4u");
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(figure, "class", "svelte-f0em4u");
			attr(h1, "class", "headline svelte-f0em4u");
			attr(div0, "class", "subheading svelte-f0em4u");
			attr(div1, "class", "body svelte-f0em4u");
			attr(div2, "class", "section-container svelte-f0em4u");
			if (!src_url_equal(img1.src, img1_src_value = /*imagep*/ ctx[9].url)) attr(img1, "src", img1_src_value);
			attr(img1, "alt", "Previous");
			attr(button0, "class", "carousel-control-prev svelte-f0em4u");
			if (!src_url_equal(img2.src, img2_src_value = /*image1*/ ctx[1].url)) attr(img2, "src", img2_src_value);
			attr(img2, "alt", "Imagen 1");
			attr(img2, "class", "svelte-f0em4u");
			attr(span0, "class", "text svelte-f0em4u");
			attr(div3, "class", "carousel-item active svelte-f0em4u");
			if (!src_url_equal(img3.src, img3_src_value = /*image2*/ ctx[2].url)) attr(img3, "src", img3_src_value);
			attr(img3, "alt", "Imagen 2");
			attr(img3, "class", "svelte-f0em4u");
			attr(span1, "class", "text svelte-f0em4u");
			attr(div4, "class", "carousel-item svelte-f0em4u");
			if (!src_url_equal(img4.src, img4_src_value = /*image3*/ ctx[3].url)) attr(img4, "src", img4_src_value);
			attr(img4, "alt", "Imagen 3");
			attr(img4, "class", "svelte-f0em4u");
			attr(span2, "class", "text svelte-f0em4u");
			attr(div5, "class", "carousel-item svelte-f0em4u");
			if (!src_url_equal(img5.src, img5_src_value = /*image4*/ ctx[4].url)) attr(img5, "src", img5_src_value);
			attr(img5, "alt", "Imagen 4");
			attr(img5, "class", "svelte-f0em4u");
			attr(span3, "class", "text svelte-f0em4u");
			attr(div6, "class", "carousel-item svelte-f0em4u");
			if (!src_url_equal(img6.src, img6_src_value = /*image5*/ ctx[5].url)) attr(img6, "src", img6_src_value);
			attr(img6, "alt", "Imagen 5");
			attr(img6, "class", "svelte-f0em4u");
			attr(span4, "class", "text svelte-f0em4u");
			attr(div7, "class", "carousel-item svelte-f0em4u");
			if (!src_url_equal(img7.src, img7_src_value = /*image6*/ ctx[6].url)) attr(img7, "src", img7_src_value);
			attr(img7, "alt", "Imagen 6");
			attr(img7, "class", "svelte-f0em4u");
			attr(span5, "class", "text svelte-f0em4u");
			attr(div8, "class", "carousel-item svelte-f0em4u");
			if (!src_url_equal(img8.src, img8_src_value = /*image7*/ ctx[7].url)) attr(img8, "src", img8_src_value);
			attr(img8, "alt", "Imagen 7");
			attr(img8, "class", "svelte-f0em4u");
			attr(span6, "class", "text svelte-f0em4u");
			attr(div9, "class", "carousel-item active svelte-f0em4u");
			attr(div10, "class", "carousel-inner svelte-f0em4u");
			attr(div11, "class", "carousel svelte-f0em4u");
			if (!src_url_equal(img9.src, img9_src_value = /*imagen*/ ctx[8].url)) attr(img9, "src", img9_src_value);
			attr(img9, "alt", "Next");
			attr(button1, "class", "carousel-control-next svelte-f0em4u");
			attr(section, "class", "svelte-f0em4u");
		},
		m(target, anchor) {
