...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(a, "class", "button svelte-p2w76q");
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h1, "class", "headline svelte-p2w76q");
			attr(div0, "class", "subheading svelte-p2w76q");
			attr(div1, "class", "body svelte-p2w76q");
			...
			attr(div2, "class", "section-containerF svelte-p2w76q");
			attr(section, "class", "svelte-p2w76q");
