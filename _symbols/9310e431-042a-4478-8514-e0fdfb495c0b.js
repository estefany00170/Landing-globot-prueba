...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(a, "class", "button svelte-9ngems");
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h1, "class", "headline svelte-9ngems");
			attr(div0, "class", "subheading svelte-9ngems");
			attr(div1, "class", "body svelte-9ngems");
			...
			attr(svg, "class", "svelte-9ngems");
			attr(figure, "class", "svelte-9ngems");
			attr(div2, "class", "section-container svelte-9ngems");
			...
			attr(section, "class", "svelte-9ngems");
