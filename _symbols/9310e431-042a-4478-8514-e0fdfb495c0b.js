...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(a, "class", "button svelte-4kugza");
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h1, "class", "headline svelte-4kugza");
			attr(div0, "class", "subheading svelte-4kugza");
			attr(div1, "class", "body svelte-4kugza");
			...
			attr(div2, "class", "section-containerF svelte-4kugza");
			attr(section, "class", "svelte-4kugza");
